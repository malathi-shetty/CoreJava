	...
	public class StringBuilder_MutableString_5 {
		...
		public static void main(String[] args) {
			...
			//H-0,e-1,l-2,l-3,o-4
					sbb.append(" World");
					System.out.println(sbb); // modify the existing value
					
					sbb.insert(2, " She");
					System.out.println(sbb); // He Shello World
					//H-0,e-1, s-2 , h-3, e -4,l-5,l-6,o-7, W-8,o-9,r-10,l-11,d-12
					sbb.replace(6, 8, "aa"); // 7 is border it wont change 7-1=6 would be replaced -- He Sheaao World
					System.out.println(sbb);
					
					sbb.deleteCharAt(3);
					System.out.println(sbb); // He heaao World
					
					sbb.reverse();
					System.out.println(sbb); //dlroW oaaeh eH
